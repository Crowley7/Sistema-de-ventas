    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">FREEDOM</small></h1>
            </div>
            <p class="lead text-center">
              Siéntase libre de poder crear una cuenta en nuestra tienda virtual de manera gratuita y aproveche las ofertas del CyberGamer. 
            <div class="row">
                <div class="col-sm-5 text-center">
                    <figure>
                      <img src="./assets/img/placas.jpg" alt="store" class="img-responsive">
                    </figure>
                </div>
                <div class="col-sm-7">
